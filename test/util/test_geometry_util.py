...
def test_geometry_util_array_types():
    ...
    try:
        ...
        _do_array_test(geom_util.q_to_quaternion, geom_util.quaternion_to_q,
                       (3,), "Quaternion", node, lambda a: rox.R2q(rox.rpy2R(a)))
        ...
        _do_array_test(geom_util.array_to_spatial_velocity,
                       geom_util.spatial_velocity_to_array, (6,), "SpatialVelocity", node)
        _do_array_test(geom_util.array_to_spatial_acceleration,
                       geom_util.spatial_acceleration_to_array, (6,), "SpatialAcceleration", node)
...
def test_geometry_util_transform_types():
    ...
    try:
        ...
        _do_transform_test(geom_util.rox_transform_to_transform,
                           geom_util.transform_to_rox_transform, "Transform", node)
        ...
        _do_named_transform_test(geom_util.rox_transform_to_named_transform,
                                 geom_util.named_transform_to_rox_transform, "NamedTransform", node)
        _do_named_transform_test(geom_util.rox_transform_to_named_pose,
                                 geom_util.named_pose_to_rox_transform, "NamedPose", node)

        _do_transform_test_xyz_rpy(geom_util.xyz_rpy_to_transform, geom_util.transform_to_xyz_rpy, "Transform", node)
        _do_transform_test_xyz_rpy(geom_util.xyz_rpy_to_pose, geom_util.pose_to_xyz_rpy, "Pose", node)
        _do_named_transform_test_xyz_rpy(geom_util.xyz_rpy_to_named_transform,
                                         geom_util.named_transform_to_xyz_rpy, "NamedTransform", node)
        _do_named_transform_test_xyz_rpy(geom_util.xyz_rpy_to_named_pose,
                                         geom_util.named_pose_to_xyz_rpy, "NamedPose", node)
