...
def test_now():
    ...
    identifier_type = RRN.GetStructureType("com.robotraconteur.identifier.Identifier")
    device_info_type = RRN.GetStructureType("com.robotraconteur.device.DeviceInfo")
    uuid_info = RRN.ArrayToNamedArray(np.array([0xa8, 0xe3, 0xc0, 0x7b, 0x12, 0xd0, 0x45, 0xd9, 0x84, 0xb0, 0x01,0xe9, 0x75, 0xf0, 0x95, 0x7f],np.uint8),uuid_dtype)
